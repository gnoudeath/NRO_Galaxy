    ...
    public class ItemHandler
    {
                    ...
                    switch (character.TypeMenu)
                    {
						...
						case 4: 
                        {
                            ...
                            if (itemShop != null)
                            {
                                ...
                                if (!character.CharacterHandler.AddItemToBag(true, itemNew, "Mua từ shop gold bar")) return;
                                itemRemove = character.ItemBag.FirstOrDefault(item => item.Id == itemIdCheck && item.Quantity >= price);
                                character.CharacterHandler.RemoveItemBagByIndex(itemRemove.IndexUI, price, reason:"Mua đồ bằng tv");
        ...
        public static void UseItemBag(Model.Character.Character character, int index, short template = -1)
        {
            try
            {
				...
				if (itemTemplate.Id == 1066)
                {
                    if (itemUse.Quantity < 999)
                    {
                        character.CharacterHandler.SendMessage(Service.ServerMessage("Không đủ mảnh"));
                        return;
                    } else
                    {
                        short g = character.InfoChar.Gender;
                        var aots = ItemCache.GetItemDefault(1048);
                        if (g == 1)
                        {
                            aots = ItemCache.GetItemDefault(1049);
                        }
                        if (g == 2)
                        {
                            aots = ItemCache.GetItemDefault(1050);
                        }
                        aots.Quantity = 1;
						var randomRate = ServerUtils.RandomNumber(0.0, 100.0);
                                    var phanTramCongThem = 0;
							...
							aots.Options.Where(option => DataCache.IdOptionGoc.Contains(option.Id)).ToList().ForEach(
                                    option => {
                                        option.Param += option.Param*phanTramCongThem/100;
                                    });
                        itemUse.Quantity -= 999;
                        character.CharacterHandler.AddItemToBag(false, aots, "Đổi Mảnh Thiên Sứ");
                        character.CharacterHandler.SendMessage(Service.SendBag(character));
                    }
                }
                if (itemTemplate.Id == 1067)
                {
                    if (itemUse.Quantity < 999)
                    {
                        character.CharacterHandler.SendMessage(Service.ServerMessage("Không đủ mảnh"));
                    ...
                    {
                        short g = character.InfoChar.Gender;
                        var aots = ItemCache.GetItemDefault(1051);
                        if (g == 1)
                        {
                            aots = ItemCache.GetItemDefault(1052);
                        }
                        if (g == 2)
                        {
                            aots = ItemCache.GetItemDefault(1053);
                        }
                        aots.Quantity = 1;
						var randomRate = ServerUtils.RandomNumber(0.0, 100.0);
                                    var phanTramCongThem = 0;
                ...
                if (itemTemplate.Id == 1068)
                {
                    ...
                    {
                        short g = character.InfoChar.Gender;
                        var aots = ItemCache.GetItemDefault(1057);
                        if (g == 1)
                        {
                            aots = ItemCache.GetItemDefault(1058);
                        }
                        if (g == 2)
                        {
                            aots = ItemCache.GetItemDefault(1059);
                        }
                        aots.Quantity = 1;
						var randomRate = ServerUtils.RandomNumber(0.0, 100.0);
                                    var phanTramCongThem = 0;
                ...
                if (itemTemplate.Id == 1069)
                {
                    ...
                    {
                        short g = character.InfoChar.Gender;
                        var aots = ItemCache.GetItemDefault(1060);
                        if (g == 1)
                        {
                            aots = ItemCache.GetItemDefault(1061);
                        }
                        if (g == 2)
                        {
                            aots = ItemCache.GetItemDefault(1062);
                        }
                        aots.Quantity = 1;
						var randomRate = ServerUtils.RandomNumber(0.0, 100.0);
                                    var phanTramCongThem = 0;
                ...
                if (itemTemplate.Id == 1070)
                {
                    ...
                    {
                        short g = character.InfoChar.Gender;
                        var aots = ItemCache.GetItemDefault(1054);
                        if (g == 1)
                        {
                            aots = ItemCache.GetItemDefault(1055);
                        }
                        if (g == 2)
                        {
                            aots = ItemCache.GetItemDefault(1056);
                        }
                        aots.Quantity = 1;
						var randomRate = ServerUtils.RandomNumber(0.0, 100.0);
                                    var phanTramCongThem = 0;
                ...
                if (itemTemplate.Type == 12)
                {
                    ...
                    {
                        UseDragonBallAsync(character, itemUse);
                    }
					if (itemTemplate.Id >= 702 && itemTemplate.Id <= 708)
                    {
                        UseRongXuong(character, itemUse);
                    }
                    return;
                }
                ...
                switch (itemTemplate.Id)
                {
                    ...
                    case 571:
                    {
                        UseCapsuleHalloween1(character, itemUse);
                        break;
                    }
                    case 572:
                    {
                        UseCapsuleHalloween2(character, itemUse);
                        break;
                    }
                    case 663:
                    case 664:
					...
					case 211:
                    {
                        UseNhoTim(character, itemUse);
                        break;
                    }
					case 212:
                    {
                        UseNhoXanh(character, itemUse);
                        break;
                    }
                }
        ...
        private static void UseCapsuleHalloween(Model.Character.Character character, Model.Item.Item item)
        {
            try
            {
                ...
                {
                    var itemAdd = ItemCache.GetItemDefault(990);
                    itemAdd.Quantity = 1;
                ...
                // - sao pha lê các loại  = 30%
                    ...
                    // var template = ItemCache.ItemTemplate(itemAdd.Id);
                    // character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
                    var itemAdd = ItemCache.GetItemDefault(681);
                    itemAdd.Quantity = 1;
                    character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                    var template = ItemCache.ItemTemplate(itemAdd.Id);
                    character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
                }  else if (randomPercent <= 30.0)
                {
                // - đồ đeo lưng = 30%
                    var ListDo = new List<short>() { 801, 802 };
                    var random = new Random();
                ...
                {
                // - 2s =20%
                    var itemAdd = ItemCache.GetItemDefault(15);
                    itemAdd.Quantity = 1;
                    character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                    var template = ItemCache.ItemTemplate(itemAdd.Id);
                    character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
                ...
                // - đồ thần linh 0.7%
                    var random = new Random();
                    int index = random.Next(DataCache.List83nm.Count);
                    short idDo83mn = DataCache.List83nm[index];
                    var itemAdd = ItemCache.GetItemDefault(idDo83mn);
                    itemAdd.Quantity = 1;
                    character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                    var template = ItemCache.ItemTemplate(itemAdd.Id);
                    character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
        ...
        //Hộp quà đỏ 8/3
        private static void UseCapsuleHalloween1(Model.Character.Character character, Model.Item.Item item)
        {
            try
            {
                character.CharacterHandler.RemoveItemBagByIndex(item.IndexUI, 1, reason:"CSKB");
                var randomPercent = ServerUtils.RandomNumber(0, 100);
                 ...
                 if (randomPercent <= 5.0)
                {
                    var itemAdd = ItemCache.GetItemDefault(742);
                    itemAdd.Quantity = 1;
                    character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                    var template = ItemCache.ItemTemplate(itemAdd.Id);
                    character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
                ...
                {            
                    var itemAdd = ItemCache.GetItemDefault(976);
                    itemAdd.Quantity = 1;
                    character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                    var template = ItemCache.ItemTemplate(itemAdd.Id);
                    character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
                ...
                {
                // - item  = 20%
                    var ListDo = new List<short>() { 14, 15, 1079};
                    var random = new Random();
                    int index = random.Next(ListDo.Count);
                    short idVatPham = ListDo[index];
                    var itemAdd = ItemCache.GetItemDefault(idVatPham);
                ...
                else if (randomPercent <= 60.0)
                {
                // - item đeo lưng = 30%
                    var ListDo = new List<short>() { 995, 996, 997, 471 };
                    var random = new Random();
                    int index = random.Next(ListDo.Count);
                    short idVatPham = ListDo[index];
                    var itemAdd = ItemCache.GetItemDefault(idVatPham);
        ...
        //Hộp quà VIP 8/3
        private static void UseCapsuleHalloween2(Model.Character.Character character, Model.Item.Item item)
        {
            try
            {
                character.CharacterHandler.RemoveItemBagByIndex(item.IndexUI, 1, reason:"CSKB");
                var randomPercent = ServerUtils.RandomNumber(0, 100);
                 ...
                 if (randomPercent <= 5.0)
                {
                    var itemAdd = ItemCache.GetItemDefault(977);
                    itemAdd.Quantity = 1;
                    character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                    var template = ItemCache.ItemTemplate(itemAdd.Id);
                    character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
                ...
                else if (randomPercent <= 10.0)
                {
                    ...
                    var itemAdd = ItemCache.GetItemDefault(975);
                    itemAdd.Quantity = 1;
                    character.CharacterHandler.AddItemToBag(true, itemAdd, "CSKB");
                    var template = ItemCache.ItemTemplate(itemAdd.Id);
                    character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().CSKB_GET, template.Name)));
                ...
                {
                // - item đeo lưng = 30%
                    var ListDo = new List<short>() { 467 , 468 , 469 , 470  };
                    var random = new Random();
                    int index = random.Next(ListDo.Count);
                    short idVatPham = ListDo[index];
                    var itemAdd = ItemCache.GetItemDefault(idVatPham);
        ...
        private static void UseCapsuleKiBi(Model.Character.Character character, Model.Item.Item item)
        {
            ...
            else if (randomPercent <= 85) // an danh
            {
            ...
            else if (randomPercent <= 88) //bo khi
            {
            ...
            else if (randomPercent <= 90) //bo huyet
            {
            ...
            else if (randomPercent <= 95) //cuong no
            {
        ...
        private static void UseBuffItem(Model.Character.Character character, Model.Item.Item item)
        {
            switch(item.Id)
            {
                ...
                case 1100:
                {
                    ...
                    character.InfoBuff.CuongNo2Time = ServerUtils.CurrentTimeMillis() + 600000;
                    break;
                }
                case 382:
                {
		...
		private static void UseNhoTim(Model.Character.Character character, Model.Item.Item item)
        {
            character.CharacterHandler.RemoveItemBagByIndex(item.IndexUI, 1, reason:"Ăn nho");
			var stamina = 10000;
            character.InfoChar.Stamina = (short)stamina;
            character.CharacterHandler.SendMessage(Service.SendBag(character));
        }
		
		private static void UseNhoXanh(Model.Character.Character character, Model.Item.Item item)
        {
            character.CharacterHandler.RemoveItemBagByIndex(item.IndexUI, 1, reason:"Ăn nho");
			var stamina = 2000;
            character.InfoChar.Stamina += (short)stamina;
        ...
        private static async Task UseDragonBallAsync(Model.Character.Character character, Model.Item.Item item)
        {
            var timeServer = ServerUtils.CurrentTimeMillis();
            ...
            //      return;
            //  }
             // Nếu rồng đã xuất hiện hoặc còn trong thời gian chờ thì không cho phép gọi rồng
            if (MapManager.IsDragonHasAppeared() || timeServer < MapManager.delayCallDragon)
            {
                character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().RONG_THAN_DANG_XUAT_HIEN));
                return;
            }

            // Thiết lập trạng thái rồng xuất hiện
            // MapManager.SetDragonAppeared(true);

            // Thiết lập thời gian kết thúc xuất hiện của rồng
            var dragonEnd = timeServer + 30000;
            ...
            // Gọi rồng thần
            // MapManager.delayCallDragon = timeServer + 50000;
            // MapManager.SetDragonAppeared(true);
            ...
            Server.Gi().Logger.Print("Player " + character.Name + " is calling dragon");
            // character.CharacterHandler.SendMessage(Service.ServerMessage("Player " + character.Name + " is calling dragon"));
            ...
            var confirmMessage = Service.OpenUiConfirm(24, MenuNpc.Gi().TextRongThan, MenuNpc.Gi().MenuDieuUocRongThan, 3);
            character.CharacterHandler.SendMessage(confirmMessage);

            // // Đợi 30 giây
            // while (timeServer < dragonEnd)
            // {
            ...
            // Đóng UI Confirm
            character.CharacterHandler.SendMessage(Service.CloseUiConfirm());

            // Thiết lập trạng thái rồng không xuất hiện
            MapManager.SetDragonAppeared(false);
            MapManager.delayCallDragon = timeServer + 30000;
		...
		private static void UseRongXuong(Model.Character.Character character, Model.Item.Item item)
        {
            ...
            // kiểm tra thử xem đủ 7 viên ngọc rồng không
            for (int dball = 702; dball <= 708; dball++)
            {
                if (character.CharacterHandler.GetItemBagById(dball) == null)
                {
                    character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().NOT_GENDER));
            ...
            // Xóa 7 viên ngọc và gọi rồng thần
            for (short dball = 702; dball <= 708; dball++)
            {
                character.CharacterHandler.RemoveItemBagById(dball, 1, reason:"Gọi rồng");
            }
            // Gọi rồng thần
            MapManager.delayCallDragon = timeServer + 100000;
            MapManager.SetDragonAppeared(true);
            character.InfoChar.CountGoiRong++;
            character.InfoMore.VuaGoiRong = true;
            character.CharacterHandler.SendMessage(Service.SendBag(character));
            ...
            // Thread.Sleep(3000);
            character.CharacterHandler.SendMessage(Service.OpenUiConfirm(27, MenuNpc.Gi().TextRongXuong, MenuNpc.Gi().MenuDieuUocRongXuong, 3));
        }
