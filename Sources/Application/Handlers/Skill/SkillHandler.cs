        ...
        public static void HandlePlayerAttackMonster(ICharacter character, SkillCharacter skillChar, SkillDataTemplate skillDataTemplate, IEnumerable<IMonster> monsters, long damage = 0, bool isCrit = false)  
        {
            ...
            if (damage == 0)
            {
                ...
                if (character.Id > 0)
                {
                    ...
                    else if (skillChar.Id == 17 && character.InfoSet.IsFullSetOcTieu)
                    {
                        damage = damage * 2;
                    }
                    else if (skillChar.Id == 9 && character.InfoSet.IsFullSetThienXinHang)
                    {
                        damage = damage * 2;
                    }
                }
                ...
                lock (monster)
                {
                    ...
                    if (monster.IsDie)
                    {
						...
						switch(task.Id)
						{
							case 1:
							{
								if(task.Index == 0)
								{
									...
									else if(monster.Id == 0 && task.Count < 4)
									{
                                        ...
                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt mộc nhân " + task.Count + "/5"));
									}
									else
									{
										task.Index++;
										task.Count = 0;
										character.CharacterHandler.SendMessage(Service.SendTask(character));
                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn đã hoàn thành nhiệm vụ."));
									}
								}
								break;
							}
										...
										switch(task.Index)
										{
											case 0:
											{
												...
												else if(monster.Id == 4 && task.Count < 2)
												{
													task.Count++;
													character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                    character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Khủng long mẹ " + task.Count + "/3"));
												}
												else
												{
													task.Index++;
													task.Count = 0;
													character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                    character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo là Lợn lòi mẹ."));
												}
												break;
											}
											case 1:
											{
												...
												else if(monster.Id == 5 && task.Count < 2)
												{
													task.Count++;
													character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                    character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Lợn lòi mẹ " + task.Count + "/3"));
												}
												else
												{
													task.Index++;
													task.Count = 0;
													character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                    character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo là Quỷ đất mẹ."));
												}
												break;
											}
											case 2:
											{
												...
												else if(monster.Id == 6 && task.Count < 2)
												{
													task.Count++;
													character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                    character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Quỷ đất mẹ " + task.Count + "/3"));
												}
												else
												{
													task.Index++;
										...
										switch(task.Index)
										{
											...
											case 1:
											{
												...
												else
												{
													...
													task.Count = 0;
													character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                    character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo là Khủng long mẹ."));
												}
												break;
											}
											case 2:
							...
							case 7:
							{
								if(task.Index == 1)
								{
									...
									else if(monster.Id == 7+character.InfoChar.Gender && task.Count < 19)
									{
										task.Count++;
										character.CharacterHandler.SendMessage(Service.SendTask(character));
                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt " + task.Count + "/20"));
									}
									else
									{
										task.Index++;
							...
							case 14:
							{
								if(character.Zone.ZoneHandler.GetCharacterClanInMap(character.ClanId).Count < 2)
								{
									break;
								}
								else
									...
									switch(task.Index)
									{
										case 0:
										{
											...
											else if(monster.Id == 16 && task.Count < 29)
											{
												task.Count++;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Heo rừng " + task.Count + "/30"));
											}
											else
											{
												task.Index++;
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Heo da xanh."));
											}
											break;
										}
										case 1:
										{
											...
											else if(monster.Id == 17 && task.Count < 29)
											{
												task.Count++;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Heo da xanh " + task.Count + "/30"));
											}
											else
											{
												task.Index++;
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Heo Xayda."));
											}
											break;
										}
										case 2:
										{
											...
											else if(monster.Id == 18 && task.Count < 29)
											{
												task.Count++;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Heo Xayda " + task.Count + "/30"));
											}
											else
											{
												task.Index++;
									...
									switch(task.Index)
									{
										case 1:
										{
											...
											else if(monster.Id == 22 && task.Count < 29)
											{
												task.Count++;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Bulon " + task.Count + "/30"));
											}
											else
											{
												task.Index++;
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Ukulele."));
											}
											break;
										}
										case 2:
										{
											...
											else if(monster.Id == 23 && task.Count < 29)
											{
												task.Count++;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Ukulele " + task.Count + "/30"));
											}
											else
											{
												task.Index++;
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Quỷ mập."));
											}
											break;
										}
										case 3:
										{
											...
											else if(monster.Id == 24 && task.Count < 29)
											{
												task.Count++;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiêu diệt Quỷ mập " + task.Count + "/30"));
											}
											else
											{
												task.Index++;
									...
									switch(task.Index)
									{
										case 1:
										{
											...
											else if(monster.Id == 27)
											{
												...
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Tambourine."));
											}
											break;
										}
										case 2:
										{
											...
											else if(monster.Id == 25)
											{
												...
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Drum."));
											}
											break;
										}
										case 3:
									...
									switch(task.Index)
									{
										case 1:
										{
											...
											else if(monster.Id == 39 && task.Count < 499)
											{
                                                ...
                                                if(task.Count % 50 == 0)
                                                    {
                                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/500 Nappa"));
                                                    }
											}
											else
											{
												...
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp tục đi, bọn chúng còn đông lắm."));
											}
											break;
										}
										case 2:
										{
											...
											else if(monster.Id == 40 && task.Count < 399)
											{
                                                ...
                                                if(task.Count % 50 == 0)
                                                    {
                                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/400 Soldier"));
                                                    }
											}
											else
											{
										...
										case 3:
										{
											...
											else if(monster.Id == 41 && task.Count < 299)
											{
                                                ...
                                                if(task.Count % 50 == 0)
                                                    {
                                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/300 Appule"));
                                                    }
											}
											else
											{
										...
										case 4:
										{
											...
											else if(monster.Id == 42 && task.Count < 199)
											{
                                                ...
                                                if(task.Count % 50 == 0)
                                                    {
                                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/200 Raspberry"));
                                                    }
											}
											else
											{
										...
										case 5:
										{
											...
											else if(monster.Id == 43 && task.Count < 99)
											{
                                                ...
                                                if(task.Count % 50 == 0)
                                                    {
                                                        character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/100 Thằn lằn xanh"));
                                                    }
											}
											else
											{
												...
												task.Count = 0;
												character.CharacterHandler.SendMessage(Service.SendTask(character));
                                                character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn đã hoàn thành nhiệm vụ, hãy về báo cáo."));
											}
											break;
										}
									}
							...
							case 26:
							{
								if (task.Index == 3)
								{
									...
									else if(monster.Id == 60 && task.Count < 899)
									{
                                        ...
                                        if(task.Count % 50 == 0)
										{
											character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/900 Xên con cấp 3"));
										}
									}
									else
									{
							...
							case 28:
							{
								if(task.Index == 4)
								{
									...
									else if(monster.Id == 62 && task.Count < 799)
									{
                                        ...
                                        if(task.Count % 50 == 0)
										{
											character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/800 Xên con cấp 5"));
										}
									}
									else
									{
							...
							case 29:
							{
								if(task.Index == 4)
								{
									...
									else if(monster.Id == 65 && task.Count < 699)
									{
                                        ...
                                        if(task.Count % 50 == 0)
										{
											character.CharacterHandler.SendMessage(Service.ServerMessage("Tiến độ: "+task.Count+"/700 Xên con cấp 8"));
										}
									}
									else
									{
								...
								switch(character.InfoChar.Task.Index)
								{
									case 0:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_KUKU_TYPE)
										{
											...
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Mập Đầu Đinh."));
									...
									case 1:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_MDD_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Rambo."));
										}
										break;
									}
									case 2:
								...
								switch(character.InfoChar.Task.Index)
								{
									case 0:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_SO4_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Số 3."));
										}
										break;
									}
									case 1:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_SO3_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Số 1."));
										}
										break;
									}
									case 2:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_SO1_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Tiểu Đội Trưởng."));
										}
										break;
									}
									case 3:
								...
								switch(character.InfoChar.Task.Index)
								{
									case 0:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_FIDE_01_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Fide 2."));
										}
										break;
									}
									case 1:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_FIDE_02_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Fide 3."));
										}
										break;
									}
									case 2:
								...
								switch(character.InfoChar.Task.Index)
								{
									case 1:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_ANDROID_19_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Android 20."));
										}
										break;
									}
									case 2:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_ANDROID_20_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo hãy tìm và tiêu diệt 900 xên con cấp 3."));
										}
										break;
									}
								}
								...
								switch(character.InfoChar.Task.Index)
								{
									case 1:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_ANDROID_15_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Android 14."));
									...
									case 2:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_ANDROID_14_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Android 13."));
										}
										break;
									}
									case 3:
								...
								switch(character.InfoChar.Task.Index)
								{
									case 1:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_PIC_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới POC."));
										}
										break;
									}
									case 2:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_POC_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới KINGKONG."));
										}
										break;
									}
									case 3:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_KINGKONG_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo hãy tìm và tiêu diệt 800 xên con cấp 5."));
										}
										break;
									}
								}
								...
								switch(character.InfoChar.Task.Index)
								{
									case 1:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_XEN_01_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Xên Bọ Hung cấp 2."));
										}
										break;
									}
									case 2:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_XEN_02_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo tới Xên Hoàn Thiện."));
										}
										break;
									}
									case 3:
									{
										...
										else if(bossReal.Type == DataCache.BOSS_XEN_HT_TYPE)
										{
											...
											character.InfoChar.Task.Count = 0;
											character.CharacterHandler.SendMessage(Service.SendTask(character));
                                            character.CharacterHandler.SendMessage(Service.ServerMessage("Tiếp theo hãy tìm và tiêu diệt 700 xên con cấp 8."));
										}
										break;
									}
								}
