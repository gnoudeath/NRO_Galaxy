            ...
            switch(Boss.Type)
            {
                ...
                case 2://black goku
                 {
                     ...
                     var item = ItemCache.GetItemDefault(((short)ServerUtils.RandomNumber(16)));
                     var itemMap = new ItemMap(playerKillId, item);
                     itemMap.X = Boss.InfoChar.X;
                     itemMap.Y = Boss.InfoChar.Y;
                     Boss.Zone.ZoneHandler.LeaveItemMap(itemMap);
                ...
                case 3://super black goku
                {
                    ...
                    if (randomPercent < 60)
                    {
                        ...
                        if (randomPercent <= 10) //giày thần 5 sao
                        {
                ...
                case 11://Cooler 02
                {
                    ...
                    else if (randomPercent <= 40)
                    {
                        ...
                        var soSao = ServerUtils.RandomNumber(4, 6);
                        if (soSao > 0)
                        {
                ...
                case 12://tho phe co
                {
                    var item = ItemCache.GetItemDefault(381);
                ...
                case 32:
                {
                        var item = ItemCache.GetItemDefault( 841, 457);
                            item.Quantity = 1;
                            var itemMap = new ItemMap(playerKillId, item);
                            itemMap.X = Boss.InfoChar.X;
                            itemMap.Y = Boss.InfoChar.Y;
                ...
                case 14:
                {
                    ...
                    {
                        // rơi trứng
                        var itemTrungLinhThu = ItemCache.GetItemDefault(1086);
                    ...
                    else if (randomPercent <= 100) // rơi cải trang ngày
                    {
                    ...
                    {
                        var itemHonLinhThu = ItemCache.GetItemDefault(1085);
                ...
                case 15://Zamasu
                    {
                        ...
                        {
                            var item = ItemCache.GetItemDefault(987);
                            item.Quantity = 5;
                            var itemMap = new ItemMap(playerKillId, item);
                            itemMap.X = Boss.InfoChar.X;
                            itemMap.Y = Boss.InfoChar.Y;
                    ...
                    case 16://Basil
                    {
                        var item = ItemCache.GetItemDefault(541,457);
                            item.Quantity = 1;
                            var itemMap = new ItemMap(playerKillId, item);
                            itemMap.X = Boss.InfoChar.X;
                            itemMap.Y = Boss.InfoChar.Y;
                ...
                case 22://Buu
                    {
                    var item = ItemCache.GetItemDefault(542);
                    var itemMap = new ItemMap(playerKillId, item);
                    itemMap.X = Boss.InfoChar.X;
                    itemMap.Y = Boss.InfoChar.Y;
                    Boss.Zone.ZoneHandler.LeaveItemMap(itemMap);
                ...
                case 23://Whis
                     {
                               ...
                               if (randomPercent <= 5)
                               {
                                   var item = ItemCache.GetItemDefault(674);
                                   var itemMap = new ItemMap(playerKillId, item);
                                   itemMap.X = Boss.InfoChar.X;
                                   itemMap.Y = Boss.InfoChar.Y;
                                   Boss.Zone.ZoneHandler.LeaveItemMap(itemMap);
                               ...
                               {
                                   var item = ItemCache.GetItemDefault(1093);
                                   var itemMap = new ItemMap(playerKillId, item);
                                   itemMap.X = Boss.InfoChar.X;
                                   itemMap.Y = Boss.InfoChar.Y;
                                   Boss.Zone.ZoneHandler.LeaveItemMap(itemMap);
                               }
                               else if (randomPercent < 15)
                               {
                                   var item = ItemCache.GetItemDefault(1094);
                                   var itemMap = new ItemMap(playerKillId, item);
                                   itemMap.X = Boss.InfoChar.X;
                                   itemMap.Y = Boss.InfoChar.Y;
                                   Boss.Zone.ZoneHandler.LeaveItemMap(itemMap);
                       ...
                       case 21://Beerus
                        {
                            ...
                            {
                                if (ServerUtils.RandomNumber(2) == 0)
                                {
                                    var itemDoThan = ItemCache.GetItemDefault(DataCache.ListDoThanLinh[ServerUtils.RandomNumber(DataCache.ListDoThanLinh.Count)]);
                                    var itemMapTL = new ItemMap(playerKillId, itemDoThan);
                                    itemMapTL.X = Boss.InfoChar.X;
