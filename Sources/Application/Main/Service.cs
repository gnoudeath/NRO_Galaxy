    ...
    public class Service
    {
        ...
        public static Message SendNewImage(int zoomLevel)
        {
            ...
            try
            {
                ...
                message.Writer.WriteShort(Cache.Gi().VersionIcon.Count);
                message.Writer.Write(Cache.Gi().VersionIcon);
        ...
        public static Message CloseUiConfirm()
        {
            var message = new Message(32);
            message.Writer.WriteShort(16);
            return message;
        }
        ...
        //40
        public static List<String> ListTextHome = new List<String>() 
        { 
        "1",
        "2",
        "3",
        ...
        public static Message SendTask(ICharacter character)
        {
            try
            {
                var task = Cache.Gi().TASK_TEMPLATES_0.Values
                    .FirstOrDefault(t => t.Id == character.InfoChar.Task.Id);
                if (character.InfoChar.Gender == 1) {
                    task = Cache.Gi().TASK_TEMPLATES_1.Values
                 .FirstOrDefault(t => t.Id == character.InfoChar.Task.Id);
                }
                ...
                message.Writer.WriteUTF(task.Name.Replace("home", ListTextHome[character.InfoChar.Gender]));
        ...
        public static Message SendImgByName(int zoomLevel, string name)
        {
            ...
            try
            {
                ...
                else if(name.Contains("7_1") || name.Contains("9_0") || name.Contains("3_1") || name.Contains("13_0") || name.Contains("13_1") || name.Contains("aura_0_0") || name.Contains("aura_0_1")) nFrame = 4;
                else if(name.Contains("aura_2_0")) nFrame = 5;
				else if(name.Contains("14_1")) nFrame = 8;
