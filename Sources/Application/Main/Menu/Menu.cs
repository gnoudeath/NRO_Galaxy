        ...
        public static void OpenUiMenu(short npcId, Character character)
        {
            ...
            try
            {
                switch (npcId)
                {
                        ...
                        switch (character.InfoChar.Task.Id)
                        {
                            ...
                            case 1:
                            {
								if(character.InfoChar.Task.Index == 1)
								{
                                    ...
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Tốt lắm, giờ con hãy đi thu thập đùi gà cho ta."));
								}
								else 
								{
                            ...
                            case 2:
                            {
								if(character.InfoChar.Task.Index == 1)
								{
									...
									character.InfoChar.Task.Count = 0;
                                    character.CharacterHandler.SendMessage(Service.SendTask(character));
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Đùi gà đây rồi, tốt lắm, haha. Ta sẽ nướng tại đống lửa đằng kia, con có thể ăn bất cứ lúc nào nếu muốn."));
								}
								else 
								{
									character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBaOngGia[0], MenuNpc.Gi().MenuBaOngGia[0], character.InfoChar.Gender));
							...
							case 3:
                            {
								if(character.InfoChar.Task.Index == 2)
								{
									...
									character.InfoChar.Task.Index = 0;
                                    character.CharacterHandler.SendMessage(Service.SendTask(character));
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Có em bé trong phi thuyền rơi xuống à, ta cứ tưởng là sao băng."));
								}
								else 
								{
									character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBaOngGia[0], MenuNpc.Gi().MenuBaOngGia[0], character.InfoChar.Gender));
							...
							case 4:
                            {
								if(character.InfoChar.Task.Index == 3)
								{
									...
									character.InfoChar.Task.Count = 0;
                                    character.CharacterHandler.SendMessage(Service.SendTask(character));
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Tốt lắm, con hoàn thành rất xuất xắc."));
								}
								else 
								{
									character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBaOngGia[0], MenuNpc.Gi().MenuBaOngGia[0], character.InfoChar.Gender));
							...
							case 7:
                            {
								if(character.InfoChar.Task.Index == 3)
								{
									...
									character.InfoChar.Task.Count = 0;
                                    character.CharacterHandler.SendMessage(Service.SendTask(character));
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Tốt lắm, con làm ta bất ngờ đấy. Bây giờ hãy đi lấy lại ngọc đem về đây cho ta."));
								}
								else 
								{
									character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBaOngGia[0], MenuNpc.Gi().MenuBaOngGia[0], character.InfoChar.Gender));
							...
							case 8:
                            {
								if(character.InfoChar.Task.Index == 2)
								{
									...
									character.InfoChar.Task.Count = 0;
                                    character.CharacterHandler.SendMessage(Service.SendTask(character));
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Xong nhiệm vụ tìm ngọc rồng 7 sao. Hãy đi tìm người thấy mới của con đi."));
								}
								else 
								{
									character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBaOngGia[0], MenuNpc.Gi().MenuBaOngGia[0], character.InfoChar.Gender));
							...
							case 9:
                            {
								if(character.InfoChar.Task.Index == 1)
								{
									...
									character.InfoChar.Task.Count = 0;
                                    character.CharacterHandler.SendMessage(Service.SendTask(character));
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Ta không nhận đệ tử đâu. Ồ con tặng ta truyện Doremon hả, thôi được nhưng con phải cố gắng luyện tập đó nhé. Hãy gia nhập một bang hội để luyện tập, sau đó quay lại đây gặp ta"));
								}
								else 
								{
									character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBaOngGia[0], MenuNpc.Gi().MenuBaOngGia[0], character.InfoChar.Gender));
						...
						if(character.InfoChar.Task.Id == 7 && character.InfoChar.Task.Index == 2 && character.InfoChar.Gender == 0)
								{
									...
									character.InfoChar.Task.Count = 0;
                                    character.CharacterHandler.SendMessage(Service.SendTask(character));
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Đá không bạn, muốn mua gì cứ tìm tới ta haha."));
								}
								else 
								{
							...
							switch (character.InfoChar.Task.Id)
							{
								...
								case 13:
								{
									if (character.InfoChar.Task.Index == 0 && character.ClanId != -1)
									{
										...
										if (clan.CurrMember >= 1)
										{
											character.InfoChar.Task.Id++;
											character.InfoChar.Task.Index = 0;
											character.CharacterHandler.SendMeMessage(Service.SendTask(character));
											character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Con hãy cùng các thành viên trong bang tiêu diệt cho ta 30 con Heo rừng, 30 con Heo da xanh và 30 con Heo Xayda."));
										}
										else {
											character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Bang hội phải 5 người, con hãy tìm thêm thành viên đi"));
										}
									}
									else 
									{
								...
								case 14:
								{
									if (character.InfoChar.Task.Index == 3)
									{
										...
										character.InfoChar.Task.Index = 0;
										character.CharacterHandler.SendMeMessage(Service.SendTask(character));
										character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Bang của con rất có tinh thần đồng đội, con hãy cùng các thành viên luyện tập chăm chỉ để thành tài nhé."));
									}
									else 
										{
											character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[0], MenuNpc.Gi().MenuQuyLao[0], character.InfoChar.Gender));
								...
								case 15:
								{
									if (character.InfoChar.Task.Index == 2)
									{
										...
										character.InfoChar.Task.Index = 0;
										character.CharacterHandler.SendMeMessage(Service.SendTask(character));
										character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Con đã tìm thấy truyện Doremon tập 2 rồi à, mau đưa cho ta nào."));
									}
									else 
										{
											character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[0], MenuNpc.Gi().MenuQuyLao[0], character.InfoChar.Gender));
								...
								case 16:
								{
									if (character.InfoChar.Task.Index == 4)
									{
										...
										character.InfoChar.Task.Count = 0;
										character.CharacterHandler.SendMeMessage(Service.SendTask(character));
										character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Con và bang hội làm rất tốt, ta có quà dành cho con."));
									}
									else 
										{
											character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[0], MenuNpc.Gi().MenuQuyLao[0], character.InfoChar.Gender));
								...
								case 18:
								{
									if (character.InfoChar.Task.Index == 4)
									{
										...
										character.InfoChar.Task.Count = 0;
										character.CharacterHandler.SendMeMessage(Service.SendTask(character));
										character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Con làm rất tốt, ta có quà dành cho con."));
									}
									else 
										{
											character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[0], MenuNpc.Gi().MenuQuyLao[0], character.InfoChar.Gender));
								...
								case 21:
								{
									if (character.InfoChar.Task.Index == 6)
									{
										...
										character.InfoChar.Task.Count = 0;
										character.CharacterHandler.SendMeMessage(Service.SendTask(character));
										character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Tốt lắm, giờ con hãy đi tiêu diệt lũ đệ tử của Fide cho ta."));
									}
									else 
										{
											character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[0], MenuNpc.Gi().MenuQuyLao[0], character.InfoChar.Gender));
								...
								case 22:
								{
									if (character.InfoChar.Task.Index == 3)
									{
										...
										character.InfoChar.Task.Count = 0;
										character.CharacterHandler.SendMeMessage(Service.SendTask(character));
										character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Rất tốt, bọn Fide đã biết sức mạnh của chúng ta."));
									}
									else 
										{
											character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextQuyLao[0], MenuNpc.Gi().MenuQuyLao[0], character.InfoChar.Gender));
								...
								case 13:
								{
									if (character.InfoChar.Task.Index == 0 && character.ClanId != -1)
									{
										...
										if (clan.CurrMember >= 1)
										{
											...
											character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Bang hội của con chưa đủ thành viên, hãy tìm thêm những thanh viên khác"));
										}
									}
									else 
									{
							...
							switch (character.InfoChar.Task.Id)
							{
								...
								case 13:
								{
									if (character.InfoChar.Task.Index == 0 && character.ClanId != -1)
									{
										...
										{
											character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Bang hội của con chưa đủ thành viên, hãy tìm kiếm thêm."));
										}
									}
									else 
									{
						...
						switch(character.InfoChar.Task.Id)
						{
							...
							case 30:
							{
								if (character.InfoChar.Task.Index == 5)
								{
									...
									character.InfoChar.Task.Count = 0;
									character.CharacterHandler.SendMeMessage(Service.SendTask(character));
									character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Chúc mừng cậu đã chiến thắng Siêu Bọ Hung\nCám ơn cậu rất nhiều\nnếu rảnh rỗi cậu hãy đến đây tìm Capsule kì bí nhá."));
								}
								else 
								{
									character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, MenuNpc.Gi().TextBumma[0], MenuNpc.Gi().MenuShopDistrict[1], character.InfoChar.Gender));
					...
					case 74:
					{
						character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId, "Nâng cấp trang bị kích hoạt\nMặc trang bị [Kích Hoạt bất kì] và ấn nâng cấp \nBắt đầu từ đồ vải thô -> đồ Thiên Sứ\nKhi nâng cấp xong trang bị sẽ tăng 1 bậc và chỉ số [Kích hoạt bất kì]\nDùng đá Vĩnh Hằng và đá Hắc Hóa để nâng cấp", MenuNpc.Gi().MenuVados[0], character.InfoChar.Gender));
                        character.TypeMenu = 0;
                        break;
					}
					case 49:
                    ...
                    case 71:
                    {
						character.CharacterHandler.SendMessage(Service.Shop(character, 3, 54));
                        character.ShopId = 54;
                        character.TypeMenu = 3;
                        break;
                    }
        ...
        public static void UiConfirm(Message message, Character character)
        {
            try
            {
                ...
                switch (npcId)
                {
                    ...
                    // shop ct
                    //  case 70: {
                    //     ConfirmShopct(character, npcId, select);
                    //     break;
                    // }
                     case 41: {
                    ...
                    switch(select)
                    {
                        ...
                        //}
                         case 0://Nhận 500k ngọc
                         {
                             ...
                             character.PlusDiamond(10000);
                             character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                             character.Delay.GetGem = timeServer + 2000;
                             character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Bạn nhận thành công 10k ngọc!"));
                             break;
                         }
                         case 1://Nhận Vàng
                                {
                                    ...
                                    //character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                                    character.Delay.GetGem = timeServer + 2000;
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, "Muốn làm mà có ăn sao, nạp đi bạn ơi"));
                                    break;
                                }
...
//
        ...
        private static void ConfirmCui(Character character, short npcId, int select)
        {
            ...
            switch (map.Id)
            {
                case 19 when @select == 0:
                {
					...
					if (character.InfoChar.Task.Id < 29) {
        ...
        {
            return type  + " [Đá Hắc hoả] và [Đá Vĩnh hằnng]";
        }
                    ...
                    switch (select)
                    {
                        case 0:
                            ...
                            else
                            {
                                ...
                                {
                                    character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateAo.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(5) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(1) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else if (checkAo.Id == 230 || checkAo.Id == 234 || checkAo.Id == 238)
                                {
                                    character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateAo.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(10) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(2) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else if (checkAo.Id == 233 || checkAo.Id == 237 || checkAo.Id == 241)
                                {
                                    character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateAo.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(15) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(3) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else if (checkAo.Id == 555 || checkAo.Id == 557 || checkAo.Id == 559)
                                {
                                   character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateAo.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(30) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(5) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else if (checkAo.Id == 650 || checkAo.Id == 652 || checkAo.Id == 654)
                                {
                                   character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateAo.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(40) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(7) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else
                                {
                        ...
                        case 1:
                            ...
                            else
                            {
                                ...
                                else if (checkQuan.Id == 651 || checkQuan.Id == 653 || checkQuan.Id == 655)
                                {
                                   character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateQuan.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(40) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(6) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else
                                {
                                    character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: [Không Hợp Lệ]" + "\n|2|Không thể Nâng Cấp", MenuNpc.Gi().MenuVados[2], character.InfoChar.Gender));
                        ...
                        case 2:
                            ...
                            else
                            {
                                ...
                                else if (checkGang.Id == 657 || checkGang.Id == 659 || checkGang.Id == 661)
                                {
                                   character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateGang.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(40) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(6) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else
                        ...
                        case 3:
                            ...
                            else
                            {
                                ...
                                else if (checkGiay.Id == 658 || checkGiay.Id == 660 || checkGiay.Id == 662)
                                {
                                   character.CharacterHandler.SendMessage(Service.OpenUiConfirm(NpcId, "|7|Vật phẩm Hiện Tại: " + templateGiay.Name + "\n|2|Sau khi Nâng Cấp trang bị của bạn sẽ tăng 1 bậc\nTiêu hao " + getTextCost(40) + "\n|0|Tỉ lệ Nâng Cấp thành công: " + getTiLe(6) + "%", MenuNpc.Gi().MenuVados[1], character.InfoChar.Gender));
                                }
                                else
                            ...
                            case 0:
                                ...
                                if (checkOption(character, 0))
                                {
                                    ...
                                    if (character.ItemBody[0].Id == 0 + character.InfoChar.Gender)
                                    {
                                        ...
                                        {
                                            if (character.CharacterHandler.GetItemBagById(dball) == null || character.CharacterHandler.GetItemBagById(dball).Quantity < 5)
                                            {
                                        ...
                                        {
                                            character.CharacterHandler.RemoveItemBagById(dball, 5, "Nâng Cấp");
                                        }
                                        character.CharacterHandler.SendMeMessage(Service.ServerMessage("Đã Nâng Cấp Thành Công !!"));
                                        character.CharacterHandler.SendMeMessage(Service.ServerChat(character.Name + " đã Nâng Cấp thành công trang bị!!!"));
                                    }
                                    else if (checkAo.Id == 230 || checkAo.Id == 234 || checkAo.Id == 238)
                                    {
                                        for (int dball = 1093; dball <= 1094; dball++)
                                        ...
                                        for (short dball = 1093; dball <= 1094; dball++)
                                        {
                                            character.CharacterHandler.RemoveItemBagById(dball, 10, "Nâng Cấp");
                                        }
                                        character.CharacterHandler.SendMeMessage(Service.ServerMessage("Đã Nâng Cấp Thành Công !!"));
                                        character.CharacterHandler.SendMeMessage(Service.ServerChat(character.Name + " đã Nâng Cấp thành công trang bị!!!"));
                                    }
                                    else if (checkAo.Id == 233 || checkAo.Id == 237 || checkAo.Id == 241)
                                    {
                                        for (int dball = 1093; dball <= 1094; dball++)
                                        {
                                            if (character.CharacterHandler.GetItemBagById(dball) == null || character.CharacterHandler.GetItemBagById(dball).Quantity < 15)
                                            {
                                                character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().NOT_GENDER));
                                                return;
                                            }
                                        ...
                                        for (short dball = 1093; dball <= 1094; dball++)
                                        {
                                            character.CharacterHandler.RemoveItemBagById(dball, 15, "Nâng Cấp");
                                        }
                                        character.CharacterHandler.SendMeMessage(Service.ServerMessage("Đã Nâng Cấp Thành Công !!"));
                                        character.CharacterHandler.SendMeMessage(Service.ServerChat(character.Name + " đã Nâng Cấp thành công trang bị!!!"));
                                    }
                                    else if (checkAo.Id == 555 || checkAo.Id == 557 || checkAo.Id == 559)
                                    {
                                        for (int dball = 1093; dball <= 1094; dball++)
                                        {
                                            if (character.CharacterHandler.GetItemBagById(dball) == null || character.CharacterHandler.GetItemBagById(dball).Quantity < 30)
                                            {
                                                character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().NOT_GENDER));
                                                return;
                                            }
                                        ...
                                        for (short dball = 1093; dball <= 1094; dball++)
                                        {
                                            character.CharacterHandler.RemoveItemBagById(dball, 30, "Nâng Cấp");
                                        }
                                        character.CharacterHandler.SendMeMessage(Service.ServerMessage("Đã Nâng Cấp Thành Công !!"));
                                        character.CharacterHandler.SendMeMessage(Service.ServerChat(character.Name + " đã Nâng Cấp thành công trang bị!!!"));
                                    }
                                    else if (checkAo.Id == 650 || checkAo.Id == 652 || checkAo.Id == 654)
                                    {
                                        for (int dball = 1093; dball <= 1094; dball++)
                                        {
                                            if (character.CharacterHandler.GetItemBagById(dball) == null || character.CharacterHandler.GetItemBagById(dball).Quantity < 40)
                                            {
                                                character.CharacterHandler.SendMessage(Service.ServerMessage(TextServer.gI().NOT_GENDER));
                                                return;
                                            }
                                        }
                                        CuongHoaTrangBi(character, 4, 0);
                                        character.CharacterHandler.RemoveItemBody(0);
                                        for (short dball = 1093; dball <= 1094; dball++)
                                        {
                                            character.CharacterHandler.RemoveItemBagById(dball, 40, "Nâng Cấp");
                                        }
                                        character.CharacterHandler.SendMeMessage(Service.ServerMessage("Đã Nâng Cấp Thành Công !!"));
                                        character.CharacterHandler.SendMeMessage(Service.ServerChat(character.Name + " đã Nâng Cấp thành công trang bị!!!"));
                                    }
                                    ...
                                    {
                                        character.CharacterHandler.SendMeMessage(Service.ServerMessage("Vật phẩm Nâng Cấp không hợp lệ!"));
                                    }
                                    break;
                                }
                                else
        ...
        public static void CuongHoaTrangBi(Character character, int set, int type)
        {
                ...
                case 4:
                    switch (type)
                    {
                        case 0:
                            ...
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1048);
                            }
                            else if (character.InfoChar.Gender == 1)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1049);
                            }
                            else if (character.InfoChar.Gender == 2)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1050);
                            }
                        ...
                        case 1:
                            ...
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1051);
                            }
                            else if (character.InfoChar.Gender == 1)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1052);
                            }
                            else if (character.InfoChar.Gender == 2)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1053);
                            }
                            break;
                        case 2:
                            if (character.ItemBody[type] == null)
                            ...
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1054);
                            }
                            else if (character.InfoChar.Gender == 1)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1055);
                            }
                            else if (character.InfoChar.Gender == 2)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1056);
                            }
                            break;
                        case 3:
                            if (character.ItemBody[type] == null)
                            ...
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1057);
                            }
                            else if (character.InfoChar.Gender == 1)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1058);
                            }
                            else if (character.InfoChar.Gender == 2)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1059);
                            }
                            break;
                        case 4:
                            if (character.ItemBody[type] == null)
                            ...
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1060);
                            }
                            else if (character.InfoChar.Gender == 1)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1061);
                            }
                            else if (character.InfoChar.Gender == 2)
                            {
                                itemCuongHoa = ItemCache.GetItemDefault(1062);
                            }
                            break;
                    }
                    break;
            ...
            character.CharacterHandler.AddItemToBag(false, itemCuongHoa, "Nâng Cấp trang bị");
            character.CharacterHandler.SendMessage(Service.SendBag(character));

        }
        public static int typeCuongHoa = 0;

        public static Action<object, object> Closed { get; internal set; }
            ...
            switch (character.TypeMenu)
            {
                ...
                case 1:
                {
                    ...
                    else if (DiemSuKien >= 7000 && DiemSuKien <= 9999)
                    {
                        ...
                        var trunglinhthu = ItemCache.GetItemDefault((short)1086);
            ...
            switch (character.TypeMenu)
            {
                ...
                case 15://nở trứng
                {
                    ...
                    if (listArray.Count == 3)
                    {
                        ...
                        character.CharacterHandler.RemoveItemBagByIndex(thoiVang.IndexUI, 50, false, reason:"Nở trứng nhanh");
                    }
                    ...
                    switch (select)
                    {
                        case 0:
                            if (UserDB.GetVND(character.Player) >= 10000)
                            {
                                ...
                                thoivang.Quantity = 50; //* DatabaseManager.Manager.gI().costDoiTien
                ...
                case 5:
                    switch (select)
                    {
                        case 0:
                            ...
                            if (!character.InfoChar.IsPremium)
                            {
                                var ctmtv = ItemCache.GetItemDefault(1078);
                                // var thoivang = ItemCache.GetItemDefault(457);
                                // thoivang.Quantity = 20;
                                // character.PlusDiamond(100000);
                                // var soluong = thoivang.Quantity;
                                character.CharacterHandler.AddItemToBag(true, ctmtv, "Mở thành viên");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                                //  character.CharacterHandler.SendMessage(Service.ServerMessage(string.Format(TextServer.gI().GET_GOLD_BAR, soluong)));
                                /// ------------->>>>
                ...
                case 6:
                    switch (select)
                    {
                            ...
                            // break;
                        {
							...
							itemAddd2.Quantity = 5;
							character.CharacterHandler.AddItemToBag(true, itemAddd2, "Mua santa");
							character.CharacterHandler.SendMessage(Service.SendBag(character));
                            UserDB.MineVND(character.Player, 10000);
                            character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn nhận được 5 đá hắc hoả và 5 đá vĩnh hằng!"));
							break;
						}
						...
						case 1:
						{
							...
							var itemAddd = ItemCache.GetItemDefault(1093);
							itemAddd.Quantity = 50;
							character.CharacterHandler.AddItemToBag(true, itemAddd, "Mua santa");
							var itemAddd2 = ItemCache.GetItemDefault(1094);
							itemAddd2.Quantity = 50;
							character.CharacterHandler.AddItemToBag(true, itemAddd2, "Mua santa");
							character.CharacterHandler.SendMessage(Service.SendBag(character));
                            UserDB.MineVND(character.Player, 100000);
                            character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn nhận được 50 đá hắc hoả và 50 đá vĩnh hằng!"));
							break;
						}
                        case 2:
                        {
                            var itemToTrade = ItemCache.GetItemDefault(674);
                            itemToTrade.Quantity = 1;

                            var itemInBag = character.CharacterHandler.GetItemBagById(674);

                            if (itemInBag == null || itemInBag.Quantity < itemToTrade.Quantity)
                            {
                                character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn không có đủ 1 viên đá ngũ sắc để đổi VND"));
                                return;
                            }

                            UserDB.AddVND(character.Player, 5000 * itemToTrade.Quantity);
                            character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn nhận được " + (5000 * itemToTrade.Quantity).ToString() + " VND!"));
                            character.CharacterHandler.RemoveItemBagById(674, 1, "Đổi 1 viên đá ngũ sắc lấy VND");
                            character.CharacterHandler.SendMessage(Service.SendBag(character));
						...
						{
                            var itemToTrade = ItemCache.GetItemDefault(674);
                            itemToTrade.Quantity = 10;

                            var itemInBag = character.CharacterHandler.GetItemBagById(674);

                            if (itemInBag == null || itemInBag.Quantity < itemToTrade.Quantity)
                            {
                                character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn không có đủ 10 viên đá ngũ sắc để đổi VND"));
                                return;
                            }

                            UserDB.AddVND(character.Player, 5000 * itemToTrade.Quantity);
                            character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn nhận được " + (5000 * itemToTrade.Quantity).ToString() + " VND!"));
                            character.CharacterHandler.RemoveItemBagById(674, 10, "Đổi 10 viên đá ngũ sắc lấy VND");
                            character.CharacterHandler.SendMessage(Service.SendBag(character));
                ...
                case 0:
                    {
                       switch (select)
                        {
                            case 0:
                            if (character.InfoChar.Task.Id < 13) {
                        character.CharacterHandler.SendMessage(Service.OpenUiSay(5, "Bạn chưa thể đến khu vực này", false, character.InfoChar.Gender));
                        return;
                    }
                    mapJoin = MapManager.Get(156);
                    break;
                            case 1:
                                break;
                        }
						...
						{ 
                            ...
                            else
                            {
								...
								if (randomRate <= 7.0)
								{
									if(gioitinh == 0)
									{
										itemAdd2 = ItemCache.GetItemDefault(1086);
									}
									else if(gioitinh == 1)
									{
        ...
        // private static void ConfirmShopct(Character character, short npcId, int select)
        // {
        //     switch (character.TypeMenu)
        //     {
        //         case 0:
            ...
            switch (character.TypeMenu)
            {
                case 0:
                {
                    switch (select)
                    {
                        ...
                        case 1:
                        { // Đổi giỏ hoa hồng type menu 2
                            character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId,
                                MenuNpc.Gi().TextNoiBanh[5], MenuNpc.Gi().MenuNoiBanh[2], character.InfoChar.Gender));
                            character.TypeMenu = 2;
                            break;
                        }
                        case 2:
                        { // Đổi hộp quà 8/3 type menu 3
                            character.CharacterHandler.SendMessage(Service.OpenUiConfirm(npcId,
                                MenuNpc.Gi().TextNoiBanh[9], MenuNpc.Gi().MenuNoiBanh[3], character.InfoChar.Gender));
                            character.TypeMenu = 3;
                            break;
                        }
                    }
                ...
                case 1: // xử lý client đã chọn đổi bó hoa
                {
                    switch (select)
                    {
                        case 0: // Đổi bó hoa hồng đỏ
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1066) == null )
                            {
                                character.CharacterHandler.SendMessage(
                            ...
                            if (
                                character.CharacterHandler.GetItemBagById(1066).Quantity < 10)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                            } else if (character.InfoChar.Gold < 50000000)
                            {
                                character.CharacterHandler.SendMessage(
                            ...
                            else
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi bó hoa hồng đỏ thành công"));
                                character.CharacterHandler.RemoveItemBagById(1066, 10, reason:"Đổi hoa");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(1069);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi bó hoa hồng đỏ");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                        }
                        case 1: // Đổi bó hoa hồng vàng
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1067) == null )
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            var randtile = ServerUtils.RandomNumber(1, 10);
                            if (
                                character.CharacterHandler.GetItemBagById(1067).Quantity < 10)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                            } else if (character.InfoChar.Gold < 50000000)
                            ...
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi bó hoa hồng xanh thành công"));
                                character.CharacterHandler.RemoveItemBagById(1067, 10, reason:"Đổi hoa");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(1070);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi bó hoa hồng xanh");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                        }
                        case 2: // Đổi bó hoa hồng xanh
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1068) == null )
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            var randtile = ServerUtils.RandomNumber(1, 10);
                            if (
                                character.CharacterHandler.GetItemBagById(1068).Quantity < 10)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                            } else if (character.InfoChar.Gold < 50000000)
                            ...
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi bó hoa hồng vàng thành công"));
                                character.CharacterHandler.RemoveItemBagById(1068, 10, reason:"Đổi hoa");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(1095);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi bó hoa hồng đỏ");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                ...
                case 2: // xử lý client đã chọn đổi giỏ hoa
                {
                    switch (select)
                    {
                        case 0: // Đổi giỏ hoa hồng đỏ
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1069) == null || character.CharacterHandler.GetItemBagById(841 ) == null)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            var randtile = ServerUtils.RandomNumber(1, 10);
                            if (
                                character.CharacterHandler.GetItemBagById(1069).Quantity < 10 ||
                                character.CharacterHandler.GetItemBagById(841).Quantity < 1)
                            ...
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi giỏ hoa hồng đỏ thành công"));
                                character.CharacterHandler.RemoveItemBagById(1069, 10, reason:"Đổi hoa");
                                character.CharacterHandler.RemoveItemBagById(841, 1, reason:"Đổi hoa");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(1096);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi giỏ hoa hồng đỏ");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                        }
                        case 1: // Đổi giỏ hoa hồng xanh
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1070) == null || character.CharacterHandler.GetItemBagById(841 ) == null)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            var randtile = ServerUtils.RandomNumber(1, 10);
                            if (
                                character.CharacterHandler.GetItemBagById(1070).Quantity < 10 ||
                                character.CharacterHandler.GetItemBagById(841).Quantity < 1)
                            ...
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi giỏ hoa hồng xanh thành công"));
                                character.CharacterHandler.RemoveItemBagById(1070, 10, reason:"Đổi hoa");
                                character.CharacterHandler.RemoveItemBagById(841, 1, reason:"Đổi hoa");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(1097);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi giỏ hoa hồng xanh");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                        }
                        case 2: // Đổi giỏ hoa hồng vàng
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1095) == null || character.CharacterHandler.GetItemBagById(841 ) == null)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            var randtile = ServerUtils.RandomNumber(1, 10);
                            if (
                                character.CharacterHandler.GetItemBagById(1095).Quantity < 10 ||
                                character.CharacterHandler.GetItemBagById(841).Quantity < 1)
                            ...
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi giỏ hoa hồng vàng thành công"));
                                character.CharacterHandler.RemoveItemBagById(1095, 10, reason:"Đổi hoa");
                                character.CharacterHandler.RemoveItemBagById(841, 1, reason:"Đổi hoa");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(1098);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi giỏ hoa hồng vàng");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                ...
                case 3: // xử lý client đã chọn đổi hộp quà 8/3
                {
                    switch (select)
                    {
                        case 0:
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1096) == null || character.CharacterHandler.GetItemBagById(1097) == null || character.CharacterHandler.GetItemBagById(1098) == null)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            var randtile = ServerUtils.RandomNumber(1, 10);
                            if (character.CharacterHandler.GetItemBagById(1096).Quantity < 1 ||
                                character.CharacterHandler.GetItemBagById(1097).Quantity < 1 ||
                                character.CharacterHandler.GetItemBagById(1098).Quantity < 1)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                            } else if (character.InfoChar.Gold < 50000000)
                            ...
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi hộp quà 8/3 thành công"));
                                character.CharacterHandler.RemoveItemBagById(1096, 1, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(1097, 1, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(1098, 1, reason:"Đổi quà");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(648);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi hộp quà 8/3");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                        }
                        case 1: //Đổi hộp quà đỏ 8/3
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1096) == null || character.CharacterHandler.GetItemBagById(1097) == null || character.CharacterHandler.GetItemBagById(1098) == null || character.CharacterHandler.GetItemBagById(541) == null)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            var randtile = ServerUtils.RandomNumber(1, 10);
                            if (character.CharacterHandler.GetItemBagById(1096).Quantity < 5 ||
                                character.CharacterHandler.GetItemBagById(1097).Quantity < 5 ||
                                character.CharacterHandler.GetItemBagById(1098).Quantity < 5 ||
                                character.CharacterHandler.GetItemBagById(541).Quantity < 1)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                            } else if (character.InfoChar.Gold < 50000000)
                            ...
                            else
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi hộp quà 8/3 thành công"));
                                character.CharacterHandler.RemoveItemBagById(1096, 5, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(1097, 5, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(1098, 5, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(541, 1, reason:"Đổi quà");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(571);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi hộp quà đỏ 8/3");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                        }
                        case 2: // Đổi hộp quà VIP 8/3
                        { // kiểm tra trước tránh null chết sv
                            if (character.CharacterHandler.GetItemBagById(1096) == null || character.CharacterHandler.GetItemBagById(1097) == null || character.CharacterHandler.GetItemBagById(1098) == null || character.CharacterHandler.GetItemBagById(541) == null || character.CharacterHandler.GetItemBagById(542) == null)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                                break;
                            ...
                            if (character.CharacterHandler.GetItemBagById(1096).Quantity < 5 ||
                                ...
                                character.CharacterHandler.GetItemBagById(1097).Quantity < 5 ||
                                character.CharacterHandler.GetItemBagById(541).Quantity < 1 ||
                                character.CharacterHandler.GetItemBagById(542).Quantity < 1)
                            {
                                character.CharacterHandler.SendMessage(
                                    Service.ServerMessage("Bạn không có đủ nguyên liệu"));
                            } else if (character.InfoChar.Gold < 50000000)
                            ...
                            {
                                character.CharacterHandler.SendMessage(Service.NpcChat(npcId,
                                    "Chúc mừng bạn đã đổi hộp quà 8/3 VIP thành công"));
                                character.CharacterHandler.RemoveItemBagById(1096, 5, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(1097, 5, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(1098, 5, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(541, 1, reason:"Đổi quà");
                                character.CharacterHandler.RemoveItemBagById(542, 1, reason:"Đổi quà");
                                character.MineGold(50000000);
                                var itemAdd = ItemCache.GetItemDefault(572);
                                character.CharacterHandler.AddItemToBag(true, itemAdd, "Đổi hộp quà VIP 8/3");
                                character.CharacterHandler.SendMessage(Service.SendBag(character));
                                character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                            }
                            break;
                ...
                case 0:
                    {
                       switch (select)
                        {
                            case 0:
                            if (character.InfoChar.Task.Id < 20) {
                        character.CharacterHandler.SendMessage(Service.OpenUiSay(5, "Bạn chưa thể đến khu vực này", false, character.InfoChar.Gender));
                        return;
                    }
        ...
        internal static void CloseUiMenu()
        {
            throw new NotImplementedException();
        }
        #endregion
