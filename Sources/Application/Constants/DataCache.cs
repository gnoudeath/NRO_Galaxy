...
namespace NRO_Server.Application.Constants
{
    public class DataCache
    {
        ...
        public static readonly long PREMIUM_LIMIT_UP_POWER = 180000000000;
        ...
        public static readonly int LIMIT_TRAIN_MANH_VO_BONG_TAI_NGAY = 9999; //1 ngày chỉ train 400 mảnh
        public static readonly int LIMIT_TRAIN_MANH_HON_BONG_TAI_NGAY = 1500;

        public static readonly int LIMIT_SLOT_RUONG_PHU_THUONG_DE = 100;

        public static List<short> LIMIT_SO_LAN_GOI_RONG = new List<short> { 1, 10 };//tài khoản thường, tài khoản premium

        public static readonly int LIMIT_NOT_PREMIUM_TRADE_DAY = 10;//ngày giao dịch 10 lần

        public static readonly long LIMIT_NOT_PREMIUM_TRADE_TIME = 20000;//10p giao dich 1 lan
        ...
        public static readonly int PRICE_UNLOCK_SPECIAL_SKILL_VIP = 30000000; //vàng

        public static readonly long MAX_PLUS_BAG = 60;
        ...
        public static List<int> IdMapNguHanhSon = new List<int> { 122, 123, 124 };
        ...
        public static List<int> ItemPremiumTrade = new List<int> { 457, 934, 886, 887, 888, 889, 987, 1087 };
        public static List<int> ItemNormalTrade = new List<int> { 379, 381, 382, 383, 384, 385, 1100 };
        ...
        public static List<short> IdMount = new List<short> { 349, 350, 351, 396, 532, 346, 347, 348, 733, 734, 735, 743, 744, 746, 795, 849, 897, 920, 1079 };
        ...
        public static List<short> List83nm = new List<short>() { 987, 16, 473,15 };
        public static List<short> List83nmd = new List<short>() { 801,802 };
        ...
        public static readonly int DIV_FAKE_PERCENT_PL = 1;//Chia tỉ lệ phần trăm thành công khi đục lổ trang bị, 50%/3 = 15% thành công
        public static readonly int DIV_FAKE_PERCENT_UPGRADE = 1;//
        ...
        public static int[][] PercentPhaLe = new int[][]{
            ...
            new int[] {60, 10, 50},
            new int[] {90, 5, 60},
            new int[] {120, DIV_FAKE_PERCENT_PL, 70},
            new int[] {180, DIV_FAKE_PERCENT_PL, 140}
            // new int[] {190, 2, 140},
            // new int[] {200, 1, 180}
        };
        ...
        public static List<int> PercentUpgradePorata2Option = new List<int> { 100, 500000000, 40 };
        ...
        public static List<short> IdSkillDisciple4 = new List<short>() { 12, 12, 12, 19, 12, 12, 19, 13, 12 };
        ...
        public static readonly int BOSS_ZAMASU_TYPE = 15;
        public static readonly int BOSS_BASIL_TYPE = 16;
        public static readonly int BOSS_LAVENDER_TYPE = 17;
        public static readonly int BOSS_BERGAMO_TYPE = 18;
        public static readonly int BOSS_COLER_VANG_TYPE = 19;
        public static readonly int BOSS_HIT_TYPE = 20;
        public static readonly int BOSS_BEERUS_TYPE = 21;
        public static readonly int BOSS_BUU_TYPE = 22;
        public static readonly int BOSS_WHIS_TYPE = 23;
        public static readonly int BOSS_SUPER_ADR17_TYPE = 24; 
        
        public static readonly int BOSS_SO1_TYPE = 28;
        public static readonly int BOSS_SO2_TYPE = 27;
        public static readonly int BOSS_SO3_TYPE = 26;
        public static readonly int BOSS_SO4_TYPE = 25;
        public static readonly int BOSS_TDT_TYPE = 29;
		
        public static readonly int BOSS_KUKU_TYPE = 49;
        public static readonly int BOSS_MDD_TYPE = 50;
        public static readonly int BOSS_RAMBO_TYPE = 51;
		
        public static readonly int BOSS_ANDROID_20_TYPE = 37;
        public static readonly int BOSS_ANDROID_19_TYPE = 36;
        public static readonly int BOSS_ANDROID_15_TYPE = 35;
        public static readonly int BOSS_ANDROID_14_TYPE = 34;
        public static readonly int BOSS_ANDROID_13_TYPE = 33;
		
        public static readonly int BOSS_PIC_TYPE = 38;
        public static readonly int BOSS_POC_TYPE = 39;
        public static readonly int BOSS_KINGKONG_TYPE = 40;
		
        public static readonly int BOSS_XEN_01_TYPE = 52;
        public static readonly int BOSS_XEN_02_TYPE = 53;
        public static readonly int BOSS_XEN_HT_TYPE = 54;
		
        public static readonly int BOSS_XEN_CON_01_TYPE = 41;
        public static readonly int BOSS_XEN_CON_02_TYPE = 42;
        public static readonly int BOSS_XEN_CON_03_TYPE = 43;
        public static readonly int BOSS_XEN_CON_04_TYPE = 44;
        public static readonly int BOSS_XEN_CON_05_TYPE = 45;
        public static readonly int BOSS_XEN_CON_06_TYPE = 46;
        public static readonly int BOSS_XEN_CON_07_TYPE = 47;
        public static readonly int BOSS_SBH_TYPE = 48;
        public static readonly int BOSS_Tau77_TYPE = 55;
        public static readonly int BOSS_Bojack_TYPE = 56;

        public static readonly int BOSS_THOXANH_TYPE = 30;
        public static readonly int BOSS_THODO_TYPE = 31;
        public static readonly int BOSS_THODEN_TYPE = 32;
        ...
        #region Lucky Box
        public static List<short> LuckBoxRare = new List<short>() { 729, 1101, 1101, 729, 1101, 1101, 1091, 1101, 1101, 729, 1101, 1101, 1091, 729, 1101, 1101, 729, 1091, 729, 1101, 729, 1092, 1101, 1101, 729, 1092, 729, 998, 999,1000,1001};
