...
namespace NRO_Server.Application.Threading
{
    public class BossRunTime
    {
        ...
        private static List<int> FideMaps = new List<int>{79,82,83};
        ...
        private static List<int> thoxanhMaps = new List<int> { 8,9,10 };
        ...
        private static List<int> thodoMaps = new List<int> { 15,16,17 };
        ...
        private static List<int> thodenMaps = new List<int> { 1,2,3 };
        ...
        private static List<int> HitMaps = new List<int> { 19 };
        ...
        private static List<int> BasilMaps = new List<int> { 122 };
        ...
        private static List<int> lavenderMaps = new List<int> { 122 };
        ...
        private static List<int> bergamoMaps = new List<int> { 122 };
        ...
        private static List<int> BuuMaps = new List<int> { 84 };
            ...
            new Thread(new ThreadStart(() =>
            {
                while (Server.Gi().IsRunning)
                {
                    ...
                    try
                    {
                        ...
                        if ((now.Hour == 5 || now.Hour == 6 || now.Hour == 7 || now.Hour == 8 || now.Hour == 9 || now.Hour == 10 || now.Hour == 11 ||now.Hour == 12 || now.Hour == 13 ||now.Hour == 14 ||now.Hour == 15 ||now.Hour == 16 ||now.Hour == 17 ||now.Hour == 18 ||now.Hour == 19 ||now.Hour == 20 ||now.Hour == 21 || now.Hour == 22 ||now.Hour == 23 || now.Hour == 1 || now.Hour == 2 || now.Hour == 3 || now.Hour == 4) && (xbhSpawnTimeDelay < ServerUtils.CurrentTimeMillis())) 
                        {
                        ...
                        {
                            WhisSpawnTimeDelay = 500000 + ServerUtils.CurrentTimeMillis();
                            if (!IsWhisSpawn)
                            {
                                IsWhisSpawn = true;
                                int sbRandomZoneNum = ServerUtils.RandomNumber(0, 15);
