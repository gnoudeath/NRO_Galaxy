...
namespace NRO_Server.Model.Character
{
    public class Disciple : CharacterBase
    {
        ...
        public void CreateNewDisciple(Character character)
        {
            ...
            InfoChar.MaxStamina = 1250;
            IsFire = true;
            InfoChar.OriginalHp = InfoChar.Hp = ServerUtils.RandomNumber(1280, 2200);
            InfoChar.OriginalMp = InfoChar.Mp = ServerUtils.RandomNumber(1280, 2200);
            InfoChar.OriginalDamage = ServerUtils.RandomNumber(60, 90);
            InfoChar.OriginalDefence = ServerUtils.RandomNumber(40, 80);
		...
		public void CreateNewMiNuongDisciple(Character character, sbyte gender)
        {
            InfoChar.Gender = gender;
            InfoChar.Power = 1500000;
            InfoChar.Level = (sbyte)Cache.Gi().EXPS.Count(exp => exp < InfoChar.Power);
		...
		public void CreateNewGatchanDisciple(Character character, sbyte gender)
        {
            InfoChar.Gender = gender;
            InfoChar.Power = 1500000;
            InfoChar.Level = (sbyte)Cache.Gi().EXPS.Count(exp => exp < InfoChar.Power);
        ...
        private short HeadLevel()
        {
            ...
            {
                0 => InfoChar.Power <= 1500000 ? (short) 1128 : (short) 1128,
                1 => InfoChar.Power <= 1500000 ? (short) 508 : (short) 508,
                _ => InfoChar.Power <= 1500000 ? (short) 550 : (short) 550
            };
        }
